  ...
  IF(FLYCAPTURE_LAYOUT STREQUAL "flycapture")
    IF(PREFER_64_BIT)
      IF(EXISTS ${FLYCAPTURE_ROOT}/lib64)
        ...
        MESSAGE(STATUS "building FlyCapture2 64-bit backend")
      ELSE(EXISTS ${FLYCAPTURE_ROOT}/lib64)
        SET(FLYCAPTURE_TEST_LIB_PATHS ${FLYCAPTURE_ROOT}/lib)
        MESSAGE(STATUS "building FlyCapture2 32-bit backend")
    ...
    ENDIF(PREFER_64_BIT)
	message(STATUS ${FLYCAPTURE_TEST_LIB_PATHS})
...
IF(NOT "$ENV{FLYCAPTURE_CMAKE_DEBUG}" STREQUAL "")
  MESSAGE(STATUS "FLYCAPTURE_TEST_INCLUDE_PATHS " ${FLYCAPTURE_TEST_INCLUDE_PATHS})
  MESSAGE(STATUS "FLYCAPTURE_TEST_LIB_PATHS " ${FLYCAPTURE_TEST_LIB_PATHS})
